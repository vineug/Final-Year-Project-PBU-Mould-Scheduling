...
Usage (Colab):
    See colab_launcher.py for instructions on running from Google Colab.
"""
...
# ============================================================
# CORE PLACEMENT FUNCTIONS (corrected handedness)
# ============================================================
...
# ============================================================
# MOULD LAYOUT VISUALISATION (Plotly SVG-like)
# ============================================================
...
with st.sidebar:
    ...
    if data_source == "Upload CSV":
        ...
        if uploaded:
            ...
            import os
            default_csv = os.path.join(os.path.dirname(__file__), "data", "panels.csv")
